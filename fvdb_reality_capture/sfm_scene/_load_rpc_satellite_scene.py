...
def load_rpc_satellite_scene(data_path: pathlib.Path):
    """
    Load cameras, posed-images, and points from a directory of GeoTiffs with associated RPCs and digital elevation model GeoTiffs.

    The directory should contain:
        - images/: A directory of GeoTiff images with .json metadata files containing RPCs.
        - elevations/: A directory of GeoTiff images containig DEM information for each GeoTiff
    ...
    Returns:
        sfm_scene (SfmScene): An in-memory representation of the SfmScene for the region covered by the satellite imagery.
    """
    ...
    for i, camera in enumerate(cameras):
        ...
        camera_type = SfmCameraType.OPENCV
        camera_id = i + 1
